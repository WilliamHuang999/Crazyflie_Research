 ...
 * @brief Roll rate setpoint
 */
LOG_ADD(LOG_FLOAT, roll_setpoint, &pidRollRate.desired)
/**
 * @brief Pitch rate setpoint
 */
LOG_ADD(LOG_FLOAT, pitch_setpoint, &pidPitchRate.desired)
/**
 * @brief Yaw rate setpoint
 */
LOG_ADD(LOG_FLOAT, yaw_setpoint, &pidYawRate.desired)
/**
