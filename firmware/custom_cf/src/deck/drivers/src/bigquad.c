...
// Parameters to track PM and OSD initialization
PARAM_ADD_CORE(PARAM_UINT8 | PARAM_RONLY, bcBigQuadPM, &pmIsInit)
PARAM_ADD_CORE(PARAM_UINT8 | PARAM_RONLY, bcBigQuadOSD, &osdIsInit)
